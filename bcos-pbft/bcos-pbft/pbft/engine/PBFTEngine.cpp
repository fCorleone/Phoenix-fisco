...
#include <phoneix-test/UnderlyingChaos.h>
    ...
    PBFTProposalInterface::Ptr _proposal, PBFTProposalInterface::Ptr _executedProposal)
{
    ...
    randomNetworkChaos(m_nodeConfig->p2pListenPort(),m_nodeConfig->nodeName(),hook_position);
    writeReproduceSignal(m_nodeConfig->nodeName(),hook_position,Signal::READY);
